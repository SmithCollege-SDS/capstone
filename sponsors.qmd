...
```{r}
semester_start <- as.Date("2026-09-08")
semester_end <- as.Date("2026-12-15")
```
## About the course
...
By `r format(semester_start - lubridate::days(10), "%B %e, %Y")`: Contact Ben Baumer (<bbaumer@smith.edu>) with: 
...
By `r format(semester_start, "%B %e")`:
