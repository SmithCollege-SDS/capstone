...
```{r}
semester_start <- as.Date("2027-01-25")
semester_end <- as.Date("2027-04-30")
```
## About the course
...
The next iteration of the course starts **`r format(semester_start, "%B %e, %Y")`** and ends `r format(semester_end, "%B %e, %Y")`. 
If you are interested in sponsoring a project, we'll need:

:::

By `r format(semester_start - lubridate::days(35), "%B %e, %Y")`: Contact Shiya Cao (<scao53@smith.edu>) with: 
...
By `r format(semester_start - lubridate::days(14), "%B %e, %Y")`:
...
#### Julian Trajanson, Civic, CTO

"The students from the Smith College Data Science Clinic performed at a level that exceeded what we have seen from many working data science professionals. From the beginning, the team was exceptionally professional, fully committed to the project, and rigorous and analytical in its approach. They conducted a thorough review of state-of-the-art techniques, designed and carried out data-driven experiments, and used their findings to select and develop the strongest solution. Their work ultimately resulted in an innovative contrastive learning–based approach that has since been incorporated into our product. A video of the team’s final presentation is [available on our website](https://www.youtube.com/watch?v=65umkR69TUA)."
